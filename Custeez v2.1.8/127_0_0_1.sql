...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2016 at 07:25 AM
...
('oioo', '1', '', '[{"12450":{"title":"oo","desc":"ooo","type":"text"}}]', 14);
...
INSERT INTO `processes` (`processName`, `processDetails`, `pubType_id`, `owner_id`, `process_id`) VALUES
('Haga', 'wegf', 1, 1, 15);
...
CREATE TABLE `submittedforms` (
  `subForm_id` varchar(100) NOT NULL,
...
--
ALTER TABLE `steps`
  MODIFY `step_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
('root', '[{"db":"custeez","table":"steps"},{"db":"custeez","table":"processes"},{"db":"custeez","table":"forms"},{"db":"custeez","table":"publicity"},{"db":"custeez","table":"groups"},{"db":"custeez","table":"users"},{"db":"custeez","table":"submittedforms"},{"db":"custeez","table":"status"},{"db":"custeez","table":"records"}]');
...
('root', '2016-02-04 08:40:58', '{"collation_connection":"utf8mb4_unicode_ci"}');
