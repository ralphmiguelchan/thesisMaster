...
<title>Custeez Group List</title>
...
<link rel="stylesheet" type="text/css" href="dist/sweetalert.css">
<meta http-equiv="Content-Type" content="text/html; charset=Cp1252">
<title>Custeez Process List</title>
...
<div id="addExistingForm" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <a class="hvr-good" href="viewform.php?sid=1"><button type="button" class="btn btn-success" data-dismiss="modal">View</button></a><a href=""><button type="button" class="btn btn-primary" data-dismiss="modal">Use</button></a>
      </div>
</center>
      </div>
      </div>
      ...
      <div class="modal-body">
       <form name="editProcForm" id="editProcForm" method="POST">
        ...
        <label for="publicity">Process Publicity: </label>
           <input type="radio" class="form-control"  data-on-color="success" value="1" id="publicity" name="publicity">Public
           <input type="radio" class="form-control"  data-on-color="success" value="2" id="publicity" name="publicity">Private
